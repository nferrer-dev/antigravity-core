...
(async () => {
    ...
    let aChecked = await page.evaluate(el => el.hasAttribute('checked'), radioA);
    let bChecked = await page.evaluate(el => el.hasAttribute('checked'), radioB);
    ...
    aChecked = await page.evaluate(el => el.hasAttribute('checked'), radioA);
    bChecked = await page.evaluate(el => el.hasAttribute('checked'), radioB);
